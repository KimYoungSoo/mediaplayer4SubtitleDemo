...
public class Metadata
{
    ...
    // STA extended start.
    public static final int CODEC_ID                = 32;
    ...
    public static final int SUBTITLE_TYPE           = 37;
    public static final int SUBTITLE_CODE_TYPE      = 38;
    public static final int SUBTITLE_LANGUAGE_TYPE  = 39;
    public static final int DIVX_TITLE_NUM          = 40;
    public static final int DIVX_EDITION_NUM        = 41;
    public static final int DIVX_CHAPTER_NUM        = 42;
    public static final int DIVX_AUTOCHAPTER_NUM    = 43;
    public static final int DIVX_FILE_POS           = 44;
    public static final int DIVX_PTS                = 45;
    public static final int DIVX_RESUME_MKV         = 46;
    public static final int DIVX_TITLE              = 47;
    public static final int DIVX_EDITION            = 48;
    public static final int DRM_RENTAL_CODE         = 49;
    public static final int DRM_RENTAL_FILE         = 50;
    public static final int DRM_RENTAL_LIMIT        = 51;
    public static final int DRM_RENTAL_USECOUNT     = 52;
    public static final int DRM_CHECKSUM            = 53;
    public static final int DRM_RENTAL_STATUS       = 54;
    public static final int DRM_FILE_FORMAT         = 55;
    public static final int DRM_AUTHORIZATION       = 56;
    // STA extended end.

    private static final int LAST_SYSTEM = 56;
    ...
    /**
     *  Get the string value indicated by key
     */
    ...
    /**
     * Get the int value indicated by key
     */
    ...
    /**
     * Get the double value indicated by key
     */
